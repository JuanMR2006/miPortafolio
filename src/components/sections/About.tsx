...
export default function About() {
  ...
  return (
    <section id="sobre-mi" className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 py-32 bg-gradient-to-b from-white to-gray-100 dark:from-gray-900 dark:to-gray-800">
